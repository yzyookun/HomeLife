...
public class ComputerMonitorUtils {
    ...
    private static final Logger logger = LoggerFactory.getLogger(ComputerMonitorUtils.class);
...
// 取进程信息
            ...
            try {
                Map<?, ?> map1 = ComputerMonitorUtils.cpuinfo();
                Thread.sleep(CPUTIME);
                Map<?, ?> map2 = ComputerMonitorUtils.cpuinfo();
...
// System.out.println("s2:"+digitS2.get(0));
    ...
    public static void main(String[] args) throws Exception {
        ...
        double cpuUsage = ComputerMonitorUtils.getCpuUsage();
//当前系统的内存使用率
        double memUsage = ComputerMonitorUtils.getMemUsage();
//当前系统的硬盘使用率
        double diskUsage = ComputerMonitorUtils.getDiskUsage();
